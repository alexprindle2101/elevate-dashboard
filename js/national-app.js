          ...
          <tbody>
            ${hist.map((r, i) => {
              ...
              return `
                <tr>
                  <td class="bold">${this._esc(r.date)}</td>
                  <td class="num">${r.tA}<span class="prod-trend-suffix"> of ${r.tG} ${this._trendArrow(r.tA, prev?.tA)}</span></td>
                  <td class="num">${r.wA}<span class="prod-trend-suffix"> of ${r.wG} ${this._trendArrow(r.wA, prev?.wA)}</span></td>
                </tr>`;
            }).join('')}
          </tbody>
        </table>
