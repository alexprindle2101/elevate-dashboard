        ...
        <div class="tools-card-header">
          ...
          <div style="display:flex;align-items:center;gap:10px;">
            <select id="asrf-sort-select" class="tools-input" style="padding:4px 8px;font-size:11px;min-width:140px;">
              ...
              <option value="opens-asc">Opens ↑</option>
              <option value="aiBooked-desc">AI Booked ↓</option>
              <option value="aiBooked-asc">AI Booked ↑</option>
              <option value="recruiterBooked-desc">Rec Booked ↓</option>
              <option value="recruiterBooked-asc">Rec Booked ↑</option>
              <option value="pctCallList-desc">% Call List ↓</option>
              <option value="pctCallList-asc">% Call List ↑</option>
              <option value="firstCalendar-desc">1st Calendar ↓</option>
              <option value="firstCalendar-asc">1st Calendar ↑</option>
              <option value="firstShowed-desc">1st Showed ↓</option>
              <option value="firstShowed-asc">1st Showed ↑</option>
              <option value="turnedTo2nd-desc">→ 2nd ↓</option>
              <option value="turnedTo2nd-asc">→ 2nd ↑</option>
              <option value="retention1st-desc">Ret 1st ↓</option>
              <option value="retention1st-asc">Ret 1st ↑</option>
              <option value="conversion-desc">Conversion ↓</option>
              <option value="conversion-asc">Conversion ↑</option>
              <option value="secondBooked-desc">2nd Booked ↓</option>
              <option value="secondBooked-asc">2nd Booked ↑</option>
              <option value="secondShowed-desc">2nd Showed ↓</option>
              <option value="secondShowed-asc">2nd Showed ↑</option>
              <option value="retention2nd-desc">Ret 2nd ↓</option>
              <option value="retention2nd-asc">Ret 2nd ↑</option>
              <option value="newStartsScheduled-desc">NS Sched ↓</option>
              <option value="newStartsScheduled-asc">NS Sched ↑</option>
              <option value="newStartsShowed-desc">NS Showed ↓</option>
              <option value="newStartsShowed-asc">NS Showed ↑</option>
